...
public class Eje5 {
   ...
   public static void main(String[] args) {
      ...
      PlataformaEducativa pe = new PlataformaEducativa(List.of(c1, c2, c3, c4), List.of(cus1, cus2),
